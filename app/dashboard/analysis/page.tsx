...
import { PERF_NORMAL, PERF_CRITICAL, MAX_DATE_RANGE_DAYS } from '@/lib/string-health'
    ...
    <div className="p-6 space-y-4">
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-4 text-[10px] text-gray-500">
          ...
          <span className="flex items-center gap-1"><span className="w-3 h-3 rounded bg-emerald-100 border border-emerald-200" /> &ge;{PERF_NORMAL}% OK</span>
          <span className="flex items-center gap-1"><span className="w-3 h-3 rounded bg-orange-100 border border-orange-300" /> {PERF_CRITICAL}%–{PERF_NORMAL - 1}% Watch</span>
          <span className="flex items-center gap-1"><span className="w-3 h-3 rounded bg-red-100 border border-red-300" /> &lt;{PERF_CRITICAL}% Critical</span>
