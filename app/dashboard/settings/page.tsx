        ...
        <div className="space-y-3 max-w-xl">
          ...
          <div className="bg-white rounded-md border border-slate-200 overflow-hidden">
            <div className="flex items-center gap-2 px-5 py-3 border-b border-slate-200">
              <User className="h-3.5 w-3.5 text-solar-gold-600" />
              <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider">Profile</h3>
            </div>
            <div className="p-5 space-y-0">
              {[
                ...
                <div key={row.label} className="flex justify-between py-2.5 border-b border-slate-100 last:border-0">
                  ...
                  {row.badge ? (
                    <span className="text-[10px] font-bold text-solar-gold-700 uppercase tracking-wider">{row.value}</span>
                  ) : (
          ...
          <div className="bg-white rounded-md border border-slate-200 overflow-hidden">
            <div className="flex items-center gap-2 px-5 py-3 border-b border-slate-200">
              <Building2 className="h-3.5 w-3.5 text-solar-gold-600" />
              <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider">Organization</h3>
            </div>
            <div className="p-5">
              <div className="flex justify-between">
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Organization</span>
                <span className="text-xs font-semibold text-slate-700">{user.profile.organizationName || 'Not assigned'}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-md border border-slate-200 overflow-hidden">
            <div className="flex items-center gap-2 px-5 py-3 border-b border-slate-200">
              <Mail className="h-3.5 w-3.5 text-solar-gold-600" />
              <h3 className="text-xs font-bold text-slate-900 uppercase tracking-wider">Support</h3>
            </div>
            <div className="p-5">
              <p className="text-[11px] text-slate-500">For account changes or support, contact your administrator.</p>
            </div>
          </div>
        </div>
      )}
