    ...
    <PageWrapper title="Alerts" loading={false} error={error || undefined}>
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {/* Result count */}
          <span className="text-[11px] font-semibold text-[#898989] ml-auto">
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-center gap-3">
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 text-xs font-semibold border border-[#e5e5e5] rounded-sm text-[#525252] hover:bg-[#f5f5f5] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
